...
Living document tracking completed features and planned work. Updated
with each release.
...
| \#  | Feature                                                                                                                   | Status    |
|-----|---------------------------------------------------------------------------------------------------------------------------|-----------|
| 1   | [`glassTabCondition()`](https://prigasg.github.io/glasstabs/reference/glassTabCondition.md) — `conditionalPanel()` helper | ✅ v0.3.1 |
| 2   | Hidden navbar mode (`show_navbar = FALSE`)                                                                                | 📋        |
| 3   | `header` / `footer` args for content area                                                                                 | 📋        |
| 4   | `localStorage` tab persistence (`persist = "local"`)                                                                      | 📋        |
| 5   | [`glasstabs_news()`](https://prigasg.github.io/glasstabs/reference/glasstabs_news.md) — in-console changelog utility      | ✅ v0.3.1 |
