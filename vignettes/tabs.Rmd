...
`overflow = "wrap"` when two or more rows suit the layout. Menu mode keeps the
same tab content behind a compact native chooser:
...
a horizontal bar. In a vertical rail, the same argument controls how labels
