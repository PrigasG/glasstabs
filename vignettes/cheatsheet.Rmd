...
glassTabsUI(
  ...
  content_min_height = "120px",  # "0" for no minimum; stabilizes tab switching
...
- Open select dropdowns stay open while Shiny outputs update and while the window resizes, but they close when a full-screen overlay (loading screen, modal, veil) appears.
