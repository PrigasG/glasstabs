...
- **[Indicator Styles](indicators.html)** - compare the glass, solid, and
  underline tab indicators, vertical orientation, and `theme = "auto"`
- **[Posit Connect Workflow](posit-connect.html)** - deploy a review workflow
  page built from filters, badges, server-side tab changes, and auto theming
