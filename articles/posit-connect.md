...
`rsconnect::writeManifest()`. Its `glasstabs` dependency points at
GitHub so Connect installs the development tab APIs used by this
workflow example. Regenerate it after changing the app or its
dependencies:
